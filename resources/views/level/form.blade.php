        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route('level.create') }}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Form level</p>
                </a>
              </li>
...
<!-- overlayScrollbars -->
<script src="{{ asset('template/plugins/overlayScrollbars/js/OverlayScrollbars.min.css')}}s"></script>
<!-- AdminLTE App -->
...
<!-- ChartJS -->
<script src="{{asset ('template/plugins/chart.js/Chart.min.jss')}}"></script>
